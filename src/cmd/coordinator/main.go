...
func main() {
	...
	if *lifecycleAddr != "" {
		go serveCoordinatorLifecycle(*lifecycleAddr, control, &draining)
	}
...
func serveCoordinatorLifecycle(addr string, control *coordinator.Coordinator, draining *atomic.Bool) {
